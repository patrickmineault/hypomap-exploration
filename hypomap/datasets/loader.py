...
from .mouse_abc import get_mouse_abc_config, get_mouse_abc_extended_config, get_mouse_abc_whole_brain_config

# Registry of available datasets
DATASETS = {
    "mouse_abc": get_mouse_abc_config,
    "mouse_abc_extended": get_mouse_abc_extended_config,
    "mouse_abc_whole_brain": get_mouse_abc_whole_brain_config,
}
